...
public class AttendeeServiceTest extends ScheduleTest {
    ...
    void createAttendee(){
        ...
        when(travelAttendeeRepository.existsByTravelSchedule_ScheduleIdAndMember_EmailAndRole(schedule1.getScheduleId(), member1.getEmail(), AttendeeRole.AUTHOR))
                .thenReturn(true);
        when(memberRepository.findByEmail(member3.getEmail())).thenReturn(Optional.of(member3));
        when(travelAttendeeRepository.existsByTravelSchedule_ScheduleIdAndMember_Email(anyLong(), anyString())).thenReturn(false);


        // when, then
        assertDoesNotThrow(() ->  attendeeService.createAttendee(schedule1.getScheduleId(), member1.getEmail(), attendeeRequest));
    ...
    void createAttendeeNotFoundSchedule_dataNotFoundException(){
        ...
        DataNotFoundException fail = assertThrows(DataNotFoundException.class,
                () ->  attendeeService.createAttendee(schedule1.getScheduleId(), member1.getEmail(), attendeeRequest));
    ...
    void createAttendee_alreadyAttendeeException(){
        ...
        when(travelAttendeeRepository.existsByTravelSchedule_ScheduleIdAndMember_Email(anyLong(), anyString())).thenReturn(true);
    ...
    void validateAuthor(){
        // given
        when(travelAttendeeRepository.existsByTravelSchedule_ScheduleIdAndMember_EmailAndRole(anyLong(), anyString(), any())).thenReturn(true);

        // when, then
        assertDoesNotThrow(() -> attendeeService.validateAuthor(schedule1.getScheduleId(), member1.getEmail(), ErrorCode.FORBIDDEN_ACCESS_SCHEDULE));
    }
    ...
    void validateAuthor_forbiddenAttendeeException(){
        // given
        when(travelAttendeeRepository.existsByTravelSchedule_ScheduleIdAndMember_EmailAndRole(anyLong(), anyString(), any())).thenReturn(false);

        // when, then
        ForbiddenAttendeeException fail = assertThrows(ForbiddenAttendeeException.class,
                () -> attendeeService.validateAuthor(schedule1.getScheduleId(), member1.getEmail(), ErrorCode.FORBIDDEN_ACCESS_SCHEDULE));
    ...
    void validateAttendeeAlreadyExists(){
        ...
        // when, then
        assertDoesNotThrow(() -> attendeeService.validateAttendeeAlreadyExists(schedule1.getScheduleId(), member1.getEmail()));
    }
    ...
    void validateAttendeeAlreadyExists_conflictAttendeeException(){
        ...
        // when, then
        ConflictAttendeeException fail = assertThrows(ConflictAttendeeException.class,
                () -> attendeeService.validateAttendeeAlreadyExists(schedule1.getScheduleId(), member1.getEmail()));
    ...
    void updateAttendeePermission(){
        ...
        // when
        assertDoesNotThrow(() -> attendeeService.updateAttendeePermission(schedule1.getScheduleId(), member1.getEmail(), attendee2.getAttendeeId(), request));
    ...
    void updateAttendeePermission_forbiddenAttendeeException(){
        ...
        // when
        ForbiddenAttendeeException fail = assertThrows(ForbiddenAttendeeException.class,
                () -> attendeeService.updateAttendeePermission(schedule1.getScheduleId(), member3.getEmail(), attendee2.getAttendeeId(), request));
    ...
    void updateAttendeePermission_attendeeDataNotFoundException(){
        ...
        // when
        DataNotFoundException fail = assertThrows(DataNotFoundException.class,
                () -> attendeeService.updateAttendeePermission(schedule1.getScheduleId(), member1.getEmail(), attendee2.getAttendeeId(), request));
    ...
    void updateAttendeePermission_forbiddenUpdateAuthorPermissionException(){
        ...
        // when
        ForbiddenAttendeeException fail = assertThrows(ForbiddenAttendeeException.class,
                () -> attendeeService.updateAttendeePermission(schedule1.getScheduleId(), member1.getEmail(), attendee1.getAttendeeId(), request));
    ...
    void leaveAttendee(){
        ...
        // when
        attendeeService.leaveAttendee(schedule1.getScheduleId(), member2.getEmail());
    ...
    void leaveAttendee_forbiddenAttendeeException(){
        ...
        // when
        ForbiddenAttendeeException fail = assertThrows(ForbiddenAttendeeException.class,
                () -> attendeeService.leaveAttendee(schedule1.getScheduleId(), member1.getEmail()));
    ...
    void removeAttendee(){
        // given
        when(travelAttendeeRepository.existsByTravelSchedule_ScheduleIdAndMember_EmailAndRole(anyLong(), anyString(), any()))
                .thenReturn(true);
        when(travelAttendeeRepository.findById(anyLong())).thenReturn(Optional.of(attendee2));

        // when
        // then
        assertDoesNotThrow(() -> attendeeService.removeAttendee(schedule1.getScheduleId(), member1.getEmail(), attendee2.getAttendeeId()));
    }
    ...
    void removeAttendee_forbiddenAttendeeException(){
        ...
        // when
        ForbiddenAttendeeException fail = assertThrows(ForbiddenAttendeeException.class,
                () -> attendeeService.removeAttendee(schedule1.getScheduleId(), member1.getEmail(), attendee2.getAttendeeId()));
