...
public class TravelAttendeeRepositoryTest {
    ...
    void setUp(){
        ...
        schedule3 = travelScheduleRepository.save(TravelScheduleFixture.createSchedule("테스트3"));
    }
    ...
    void createTravelAttendee() {
        ...
        travelAttendeeRepository.save(TravelAttendeeFixture.createGuestAttendee(schedule2, member1, READ));
        travelAttendeeRepository.save(TravelAttendeeFixture.createAuthorAttendee(schedule3, member2));

        TravelAttendee guest = TravelAttendeeFixture.createGuestAttendee(schedule1, member1, ALL);
    ...
    void deleteAllByScheduleId() {
        ...
        TravelAttendee otherAttendee = travelAttendeeRepository.save(TravelAttendeeFixture.createAuthorAttendee(schedule2, member1));

        // when
        travelAttendeeRepository.deleteAllByScheduleId(schedule1.getScheduleId());
