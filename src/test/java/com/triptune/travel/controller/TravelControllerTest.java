...
public class TravelControllerTest extends TravelTest {
    ...
    void setUp(){
        ...
        district2 = districtRepository.save(createDistrict(city, "강남"));
        apiCategory = apiCategoryRepository.save(createApiCategory());

        travelPlace1 = travelPlaceRepository.save(createTravelPlace(null, country, city, district1, apiCategory, "강남 여행지", 0));
