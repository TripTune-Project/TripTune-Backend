...
public enum CityType {
    ALL("all", Set.of("서울특별시", "부산광역시", "제주특별자치도", "경기도", "강원특별자치도", "경상북도", "경상남도", "전북특별자치도", "전남광주통합특별시", "충청북도", "충청남도")),
    SEOUL( "seoul", Set.of("서울특별시")),
    BUSAN( "busan", Set.of("부산광역시")),
    JEJU( "jeju", Set.of("제주특별자치도")),
    GYEONGGI("gyeonggi", Set.of("경기도")),
    GANGWON("gangwon", Set.of("강원특별자치도")),
    GYEONGSANG("gyeongsang", Set.of("경상북도", "경상남도")),
    JEOLLA("jeolla", Set.of("전북특별자치도", "전남광주통합특별시")),
