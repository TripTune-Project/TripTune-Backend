...
public class ScheduleApiController {
    ...
    public ApiPageResponse<TravelSimpleResponse> searchTravelPlaces(@PathVariable(name = "scheduleId") Long scheduleId,
                                                                    @RequestParam(name = "page") int page,
                                                                    @RequestParam(name = "keyword") String keyword){

        Page<TravelSimpleResponse> response = scheduleService.searchTravelPlaces(scheduleId, page, keyword);
