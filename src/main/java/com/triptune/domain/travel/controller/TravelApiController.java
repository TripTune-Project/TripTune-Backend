...
public class TravelApiController {
    ...
    public ApiPageResponse<TravelResponse> findNearByTravelPlaceList(@RequestBody @Valid TravelLocationRequest travelLocationRequest, @RequestParam int page){
    ...
    public ApiPageResponse<?> searchTravelPlace(@RequestParam String type, @RequestParam String keyword, @RequestParam int page){
        Page<TravelResponse> response = travelService.searchTravelPlace(type, keyword, page);
        return ApiPageResponse.okResponse(response);
    }
