...
public class TravelPlaceDTO {
    ...
    public static class Response{
        ...
        @Builder
        public Response(Long placeId, String country, String city, String district, String address, String detailAddress, double longitude, double latitude, String placeName, String thumbnailUrl) {
        ...
        public static Response fromEntity(TravelPlace travelPlace){
        ...
        public static List<Response> entityListToDtoList(List<TravelPlace> travelPlaceList){
